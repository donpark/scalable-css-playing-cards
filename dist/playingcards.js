...
(function() {
  var CardModel, CardView, DeckModel, DeckView, NAMESPACE, RANK, RANKS, SUITE, SUITES, Templates,
  ...
  SUITES = [SUITE.club, SUITE.diamond, SUITE.spade, SUITE.heart];
  ...
  CardView = (function(_super) {
    ...
    CardView.prototype.content = function(wrap) {
      var $content, $wrap, front, rank, suite;
      front = this.model.get('front');
      if (front) {
        rank = this.model.get('rank');
        suite = this.model.get('suite');
  ...
  DeckModel = (function(_super) {
    ...
    DeckModel.prototype.initialize = function(models, options) {
      var card, front, rank, suite, _i, _len, _results;
